...
<body class="bg-black muli">
    <nav class="w-100pc flex flex-column md-flex-row md-px-10 py-5 bg-black">
        ...
        <div id="nav-items" class="hidden flex sm-w-100pc flex-column md-flex md-flex-row md-justify-end items-center">
            <a href="HospitalHome.jsp" class="fs-s1 mx-3 py-3 indigo no-underline hover-underline">Home</a>
            <a href="DoctorsList.jsp" class="fs-s1 mx-3 py-3 indigo no-underline hover-underline">Doctors List</a>
            <a href="DoctorRequests.jsp" class="fs-s1 mx-3 py-3 indigo no-underline hover-underline">Doctors Requests</a>
    ...
    <section id="home" class="min-h-100vh flex justify-start items-center">
        <div class="mx-5 md-mx-l5">
            <div>
                <h2 class="white fs-l3 lh-2 md-fs-xl1 md-lh-1 fw-900 ">Doctors Request</h2>
		...
		%>
			<section id="banner" data-video="images/banner" >
				...
				<tr style="color: white;"><th>Doctor Name</th><th>Doctor ID</th><th>Doctor Mobile</th><th>Doctor Specialization</th><th>Doctor Experience</th><th>Approve</th></tr>
				<%
				while(itr.hasNext()){
					String na = itr.next();
					String id = itr.next();
					...
					String ex = itr.next();
				%>
				<tr style="color: white;"><td><%=na %></td><td><%=id %></td>
				<td><%=mob %></td><td><%=spe %></td>
				<td><%=ex %></td>
				<td><a href="UApprove?em=<%=id%>" class="w3-button w3-white">Approve</a></td></tr>
				<%} %>
				</table>
				</div>
			</section>
